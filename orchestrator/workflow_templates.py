...
WORKFLOW_TEMPLATES = [
    {
        ...
        "definition": {
            "nodes": [
                {"id": "n1", "type": "data_collect", "name": "采集内容源",
                 "config": {"source_ids": [], "max_per_source": 10},
                 "position": {"x": 100, "y": 100}},
                {"id": "n2", "type": "ai_process", "name": "AI 加工",
                 "config": {"instruction": "对采集内容进行解读分析，输出中文摘要",
                            "fields": ["title", "summary", "body", "keywords"]},
                 "position": {"x": 320, "y": 100}},
                {"id": "n3", "type": "approval", "name": "人工审核",
                 "config": {"approver_role": "admin"},
                 "position": {"x": 540, "y": 100}},
                {"id": "n4", "type": "notify", "name": "通知管理员",
                 "config": {"channels": ["notification"], "title": "有新内容待审核"},
    ...
    },
    {
        ...
        "definition": {
            "nodes": [
                {"id": "n1", "type": "script", "name": "检查新文章",
                 "config": {"script": "check_new_posts", "lang": "builtin"},
                 "position": {"x": 100, "y": 100}},
                {"id": "n2", "type": "script", "name": "增量生成静态页",
                 "config": {"script": "generate_static_incremental", "lang": "builtin"},
                 "position": {"x": 320, "y": 100}},
                {"id": "n3", "type": "notify", "name": "通知完成",
                 "config": {"channels": ["notification"], "title": "静态站点已更新"},
                 "position": {"x": 540, "y": 100}},
            ],
            "edges": [
                ...
                {"id": "n1", "type": "condition", "name": "是否发布社媒",
                 "config": {"expression": "true",
                            "branches": [{"value": True, "to": "n2"},
                                         {"value": False, "to": "n3"}]},
                 "position": {"x": 100, "y": 100}},
                {"id": "n2", "type": "publish", "name": "发布到社媒",
                 "config": {"platforms": ["weixin", "weibo", "toutiao"]},
                 "position": {"x": 320, "y": 60}},
                {"id": "n3", "type": "notify", "name": "通知结果",
                 "config": {"channels": ["notification"], "title": "社交发布完成"},
                 "position": {"x": 540, "y": 100}},
            ],
            "edges": [
                {"from": "n1", "to": "n2", "condition": "success"},
    ...
    },
    {
        ...
        "definition": {
            "nodes": [
                {"id": "n1", "type": "data_collect", "name": "获取新文章",
                 "config": {"source_ids": [], "max_per_source": 20},
                 "position": {"x": 100, "y": 100}},
                {"id": "n2", "type": "ai_process", "name": "AI 清洗",
                 "config": {"instruction": "清洗并结构化文章内容，供知识库检索",
                            "fields": ["title", "summary", "body"]},
                 "position": {"x": 320, "y": 100}},
                {"id": "n3", "type": "notify", "name": "通知同步完成",
                 "config": {"channels": ["notification"], "title": "知识库已同步新内容"},
                 "position": {"x": 540, "y": 100}},
            ],
            "edges": [
                {"from": "n1", "to": "n2"},
