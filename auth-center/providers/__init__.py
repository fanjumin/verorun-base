#!/usr/bin/env python3
"""
Provider Registry — auth-center local copy of root providers/__init__.py

This file is kept in sync with EasyKaiSite/providers/__init__.py.
When running inside auth-center, this file resolves correctly without
needing the root directory on sys.path.
"""
import os
import importlib
