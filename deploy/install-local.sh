...
${APP_USER} ALL=(root) NOPASSWD: /bin/bash ${APP_HOME}/deploy/install-local.sh update
${APP_USER} ALL=(root) NOPASSWD: /bin/bash ${APP_HOME}/deploy/install-local.sh restart
