# Vue Plugin Template（官方模板）

基于 **插件标准 v1.5 §15 前端框架插件指南** 的最小可运行 Vue 3 插件。
...
- **iframe 路径**：`menu.embed_url` 指向 `/admin/vue-demo/`，不参与内联 `l_<key>()`
- **Vue 3.4 UMD**：系统本地静态库（`/static/lib/plugin-frameworks/vue.global.prod.js`），**禁外网 CDN**
